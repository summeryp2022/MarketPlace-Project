...
{
    public class TechSpecFilterRepository : GenericRepository<TechSpecFilterRepository>, ITechSpecFilterRepository
    {
        public TechSpecFilterRepository(DbContext context) : base(context)
        {
        }
